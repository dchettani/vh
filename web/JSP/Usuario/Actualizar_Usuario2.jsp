...
try{
    ...
    String Consulta="UPDATE Usuario SET Nombres= '" + Nombre + "', Apellidos= '" + Apellido + "', Fecha_Nacimiento= '" + Fecha + "', Direccion= '" + Direccion + "',Telefono= '" + Telefono + "',User= '" + Usuario + "',Password= '" + Contraseña + "' WHERE IdUsuario=" + Codigo;
